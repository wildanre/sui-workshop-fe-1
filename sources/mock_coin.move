module escrow::mock_coin {
    ...
    /// Initializer otomatis saat publish: buat koin, metadata, dan jadikan TreasuryCap shared untuk public minting.
    ...
    /// Mint mock coin ke sender (public untuk testing, siapa saja bisa mint).
