module escrow::mock_tbtc {
    ...
    /// Initializer otomatis saat publish: buat TBTC dan jadikan TreasuryCap shared untuk public minting.
    ...
    /// Mint TBTC ke caller (public untuk testing, siapa saja bisa mint).
